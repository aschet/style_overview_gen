...
Style: A silkscreen print with flat opaque color layers, sharp clean edges, slight color registration offsets between layers, and a bold poster-like graphic quality.
